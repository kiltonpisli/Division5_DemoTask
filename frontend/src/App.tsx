...
import { useGetCategoriesQuery, useGetMoviesByCategoryQuery, useGetMoviesDetailsQuery, useGetMoviesBySearchQuery } from './redux/services/api';
...
function App() {
  ...
  }, [catData, moviesData, movieDetailsData, moviesSearchData])
